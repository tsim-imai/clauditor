...
### 🪟 **最小ウィンドウモード**
- **常に最前面表示**: 他のウィンドウより前面に固定表示
- **コンパクトサイズ**: 420x340pxの省スペース設計
- **過去24時間データ**: リアルタイム更新の時間別トークン使用量
- **軸ラベル・罫線付きグラフ**: Chart.jsによる見やすい折れ線チャート
- **ワンクリック切り替え**: ヘッダーボタンで瞬時にモード変更
...
### 🆕 最新追加機能
- **🪟 最小ウィンドウモード**: 420x340pxの常に最前面表示
- **📊 過去24時間リアルタイムグラフ**: 時間別トークン使用量の折れ線チャート
- **⚡ 高度なリアルタイム更新**: ファイル変更の即座反映とデバッグ機能強化
- **🎨 レスポンシブUI改善**: 700px幅まで対応の最適化
